insert into book(title, author, isbn, version) values('Nineteen Eighty Four', 'George Orwell', '0000000001', 1);
insert into book(title, author, isbn, version) values('Alice''s Adventures In Wonderland', 'Lewis Carroll', '0000000002', 1);
